# 02: How to use a logistic classification model to to predict the outstanding debt value for a country given certain factors based on the World Bank International Debt Dataset. 
